 ...
 * triggered.
 * **/
class NetworkEventHandler @Inject constructor() : HandleNetworkEvent {
    override var success: () -> Unit = {}
    override var error: (String?) -> Unit = {}
    override var loading: () -> Unit = {}
    override var idle: () -> Unit = {}

    override fun setOnSuccess(onSuccess: () -> Unit) { success = onSuccess }
    override fun setOnError(onError: (String?) -> Unit) { error = onError }
